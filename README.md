...
- **Ana Capability:** ATM directory and open geospatial data
- **Dönüşüm Wave:** 1
...
- `ATM directory and open geospatial data` kapsamında kod, sözleşme, test, runbook ve release artefaktları.
